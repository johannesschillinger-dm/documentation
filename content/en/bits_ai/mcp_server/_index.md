...
- `reference-tables`: Tools for managing [Reference Tables][38], including listing tables, reading rows, appending rows, and creating tables from cloud storage
...
Lists and searches [Reference Tables][38] in the organization, with optional filtering by name and sorting.
