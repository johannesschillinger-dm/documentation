...
The Pipeline Visualization toggle in the Configurations tab of an OTel Collector provides a pipeline view of the Collector. 
Use Pipeline Visualization to:
