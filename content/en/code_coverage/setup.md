...
Use the [Datadog Code Coverage Upload][15] GitHub Action to upload coverage reports. This action uses the `datadog-ci` standalone binary and does not require Node.js:
